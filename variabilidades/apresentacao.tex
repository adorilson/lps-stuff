% ------------------------------------------------------------------------------
% Palestra: Identificando variabilidades em aplicações para Android
% Autores:
...
% ------------------------------------------------------------------------------
\title[Identificando variabilidades em aplicações para Android]
{
...
\section{Introdução}
    ...
    \frame
    {
        ...
        \begin{itemize}
            \item Leitura de trabalhos relacionados
            \item Consulta à comunidade
            \item Consulta à API (http://developer.android.com/guide/basics/what-is-android.html)
            \item Leitura de código-fonte de projetos FLOSS
        \end{itemize} 
    }
...
\section{Desenvolvimento}
    ...
    \frame
    {
		...
		\begin{itemize}
			...
			\item Suporte para midias comuns de audio, video e formatos de imagens (MPEG4, H.264, MP3, AAC, AMR, JPG, PNG, GIF)
    ...
    \frame
    {
        \frametitle{Gráficos: 2D ou 3D}
        \begin{figure}[t]
            \includegraphics[scale=0.4]{img/if_3dSupported}
            \caption{Testando se o dispositivo tem suporte para gráficos 3d}
        \end{figure} 
    }
    \frame
    {
    ...
    \frame
    {
		...
		\begin{itemize}
			...
			\item Facilita o desenvolvimento na medida em que permite o desenvolver se preocupar 
			menos com a versão da API
		\end{itemize}
    }
    \frame
    {
    ...
    \frame
    {
        ...
        \begin{itemize}
            ...
            \begin{itemize}
				...
				\item ARMv7-A (incluindo instruções Thumb-2 e VFPv3-D16, com suporte opcional para NEON/VFPv3-D32)
				\item x86
            \end{itemize}
...
\section{Conclusão}
	...
	\frame
	{
		...
		\begin{itemize}
			\item Inexperiência com a plataforma
